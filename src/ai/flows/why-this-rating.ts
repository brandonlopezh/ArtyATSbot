...
const WhyThisRatingOutputSchema = z.object({
  whyIWouldMoveForward: z.string().describe('A markdown bulleted list of reasons why a recruiter WOULD move forward with this application.'),
  whyIWouldNotMoveForward: z.string().describe("A markdown bulleted list of reasons why a recruiter WOULD NOT move forward with this application."),
});
...
const whyThisRatingPrompt = ai.definePrompt({
  ...
  **Instructions:**
  ...
  2.  For 'whyIWouldMoveForward', provide a markdown bulleted list of the strongest points that make this candidate worth interviewing. These are the green flags that catch your eye.
  3.  For 'whyIWouldNotMoveForward', provide a markdown bulleted list of the specific weak points, red flags, or areas of concern that would give you pause as a recruiter.
  4.  Be direct, honest, and base your feedback only on the provided text. Do not invent skills, experiences, or availability. Frame your points as a recruiter's thoughts. Ensure the output for both fields is a markdown bulleted list.
